...
class ContourTiles {
  ...
  /// タイルのズーム（テクスチャの段 = 表示ズーム）→ 間隔（m）。地理院地図「標準地図」の出典（地理院タイル一覧）と各図式の等高線に合わせる:
  /// ZL18 = 電子国土基本図（2500 図式: 主曲線 2 m・計曲線 10 m）、ZL15〜17 = 同（25000 図式: 10 m・50 m）、
  /// ZL12〜14 = 20 万分 1（100 m・500 m）、ZL9〜11 = 100 万分 1（200 m）。ZL8 以下は描かない（松本 2026-09-13「密度は地理院に合わせて」）
